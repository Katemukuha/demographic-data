    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(selectInput(inputId = 'categorical variables', label = "Categorical", choices = c("education", "workclass", "sex")),    # add radio buttons for categorical variables
