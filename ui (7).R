    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(inputId = "continuous_variable", label = "Continuous", choices = c("age", "hours_per_week"), selected = "hours_per_week"),   # add radio buttons for continuous variables
    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(inputId = "categorical_variable", label = "Categorical", choices = c("education", "workclass", "sex"), selected = "education"),    # add radio buttons for categorical variables
