    ...
    fluidRow(
      column(3, 
             wellPanel(
               ...
               radioButtons(inputId = "categorical variable", label = "Categorical", choices = c("education", "workclass", "sex"), selected = "education"),    # add radio buttons for categorical variables
